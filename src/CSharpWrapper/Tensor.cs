...
namespace NumpyIO
{
    ...
    public abstract class Tensor<T, B> where B : IList<T>
    {
        ...
        public T this[params uint[] multiIndex]
        {
            get
            {
                ...
                return this.get(new Shape(multiIndex));
            }
            set
            {
                if (multiIndex.Length != this.Shape.Count)
                ...
                this.set(new Shape(multiIndex), value);
            }
        }
        ...
        protected abstract T get(Shape multiIndex);

        /// <summary>
        /// Autogenereted subclasses will implement this method. Maps to
        /// \link npy::tensor::set \endlink
        /// </summary>
        protected abstract void set(Shape multiIndex, T value);
    }
}