...
namespace npy {
    ...
    public:
         ...
         */
        onpzstream(const std::string& path, compression_method compression=compression_method::STORED, endian endianness=npy::endian::NATIVE);
        ...
        /** Destructor. This will call \link npy::onpzstream::close \endlink, if it has not been called already. */
        ~onpzstream();
