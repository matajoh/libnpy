...
namespace npy {
    void write_npy_header(std::ostream& output, const std::string& dtype, bool fortran_order, const std::vector<size_t>& shape)
    {
        ...
        buff << "{'descr': '" << dtype << "', 'fortran_order': " << (fortran_order ? "True" : "False") << ", 'shape': (";
        ...
        unsigned char header[STATIC_HEADER_LENGTH] = {0x93, 'N', 'U', 'M', 'P', 'Y', 0x01, 0x00, static_cast<unsigned char>(dict_length + 1), 0x00};
