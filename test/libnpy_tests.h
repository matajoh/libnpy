...
{
    template<typename T>
    void assert_equal(const T& expected, const T& actual, int& result, const std::string& tag)
    {
        if(expected != actual)
        {
            result = EXIT_FAILURE;
    ...
    template<typename T>
    void assert_equal(const std::vector<T>& expected, const std::vector<T>& actual, int& result, const std::string& tag)
    {
    ...
    template<typename T>
    void assert_equal(const npy::tensor<T>& expected, const npy::tensor<T>& actual, int& result, const std::string& tag)
    {
    ...
    template<>
    inline void assert_equal<std::string>(const std::string& expected, const std::string& actual, int& result, const std::string& tag){
